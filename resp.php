                            ...
                            <?php
                                ...
                                switch ($payment_status) {
                                    case "approved":
                                        ...
                                        <div style="text-align: center;padding-top: 5%;"><p><b>PAGO APROBADO</b></p>
                                            <p>Id del método de pago: <?php echo $payment_method_id ?></p>
                                            <p>Monto pagado: <?php echo $transaction_amount ?></p>
                                            <p>Id de la orden: <?php echo $merchant_order_id ?></p>
                                            <p>Id delpago: <?php echo $payment_id ?></p>
                                        </div>
